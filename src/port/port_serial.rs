...
use crate::bindings::{
    mb_port_ser_parity_enum, mb_port_ser_parity_enum_MB_PAR_EVEN,
    mb_port_ser_parity_enum_MB_PAR_NONE, mb_port_ser_parity_enum_MB_PAR_ODD, mb_port_ser_struct,
    BOOL, CHAR, FALSE, TRUE, UCHAR, ULONG,
};
...
pub extern "C" fn mb_port_ser_init(
    ...
    port.configure(
        ...
        data_bits,
        match parity {
            mb_port_ser_parity_enum_MB_PAR_EVEN => crate::Parity::Even,
            mb_port_ser_parity_enum_MB_PAR_ODD => crate::Parity::ODD,
            mb_port_ser_parity_enum_MB_PAR_NONE => crate::Parity::None,
            _ => unreachable!(),
        },
    ).into()
}
